...
public class ViewRenderService
{
    ...
    public async Task<IResult> PageAsync<TModel>(string partialName, TModel model)
    {
        var resp = await RenderAsync(partialName, model);

        return Results.Content(resp, "text/html; charset=utf-8");
    }
